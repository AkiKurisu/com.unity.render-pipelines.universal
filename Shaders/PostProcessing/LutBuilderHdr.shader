...
{
    HLSLINCLUDE
        #pragma multi_compile_local _ _TONEMAP_ACES _TONEMAP_NEUTRAL _TONEMAP_UNREAL_ACES
        ...
        {
            #if defined(_TONEMAP_ACES) || defined(_TONEMAP_UNREAL_ACES)
        ...
        float3 ColorGrade(float3 colorLutSpace)
        {
            ...
            #if _TONEMAP_ACES || _TONEMAP_UNREAL_ACES
        ...
        float3 Tonemap(float3 colorLinear)
        {
            ...
            #elif _TONEMAP_UNREAL_ACES
            {
                float3 aces = ACEScg_to_ACES(colorLinear);
                colorLinear = UE_ACES(aces);
            }
            #endif
